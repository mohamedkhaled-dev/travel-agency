...
export default async function TripDetailPage({
  ...
  return (
    <main className="wrapper pb-6 sm:pb-10">
      <Header
        title="Trip Details"
      ...
      <section className="wrapper space-y-3 sm:space-y-4 mt-2 sm:mt-4">
        ...
        {/* Price Section */}
        <section className="bg-[var(--color-primary-50)] p-3 sm:p-4 rounded-[var(--radius-20)] my-2 sm:my-4">
        ...
        <section className="space-y-6 mt-6 sm:mt-8">
          <h2 className="text-xl sm:text-2xl font-bold text-[var(--color-dark-100)]">
            Daily Itinerary
          </h2>
